...
const BlogItem = ({ date, title, description }) => {
    return (
        ...
        <div className="bg-blue-900 text-white text-center p-4 flex-shrink-0">
        ...
        <div className="p-4 flex-grow flex flex-col justify-center">
          <h3 className="text-blue-900 font-bold mb-1 880:text-[22px] 950:text-[24px]">{title}</h3>
          <p className="text-gray-700 880:text-[22px] 950:text-[24px]">{description}</p>
        </div>
      </div>
    );
  };
